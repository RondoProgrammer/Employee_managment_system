...
class User(UserMixin, db.Model):
    ...
    role = db.Column(db.String(32), nullable=False)  # e.g., 'administrator', 'department_manager', 'employee'

    deparment_id = db.Column(db.Integer, db.ForeignKey('departments.id'), nullable=True)
